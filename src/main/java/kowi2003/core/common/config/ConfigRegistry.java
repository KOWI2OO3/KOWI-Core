...
import kowi2003.core.common.helpers.TypeHelper;
        ...
        for(Field field : config.getClass().getFields()) {
            ...
            try {
                ...
                if(type == Float.class || type == float.class)
                    ...
                    field.set(config, TypeHelper.getEnum(type, (String)name));
    ...
    private static <T> void constructBuilder(@Nonnull T config, @Nonnull Builder builder) {
        for(Field field : config.getClass().getFields()) {
            ...
            try {
                ...
                if(range != null && TypeHelper.isSimpleNumberType(type)) {
                ...
                else if(TypeHelper.isPrimitiveType(type))
